ShaguPlatesX:RegisterModule("gui", "vanilla", function ()
  ...
  do -- Generate Config UI
    CreateGUIEntry(T["Nameplates"], nil, function()
      ...
      CreateConfig(U["nameplates"], T["Unified Team Icon In Group"], C.nameplates, "factionicon_team", "checkbox")
      ...
      CreateConfig(U["nameplates"], T["Enable Class Colors On Enemy Name"], C.nameplates, "enemyclassnamec", "checkbox")
      CreateConfig(U["nameplates"], T["Enable Class Colors On Friend Name"], C.nameplates, "friendclassnamec", "checkbox")
