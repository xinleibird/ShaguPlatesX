...
do -- statusbars
  ...
  local animateRunning = false
  local animateOnUpdate

  local function UpdateAnimationScript()
    local hasAnimations = next(animations) ~= nil
    if hasAnimations and not animateRunning then
      animateRunning = true
      animate:SetScript("OnUpdate", animateOnUpdate)
    elseif not hasAnimations and animateRunning then
      animateRunning = false
      animate:SetScript("OnUpdate", nil)
    end
  end

  animateOnUpdate = function()
